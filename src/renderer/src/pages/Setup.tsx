...
interface SetupPageProps {
  onSetup: (user: { id: string; name: string; email: string; role: string }) => void
}
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-gray-50 to-white">
      <div className="w-full max-w-sm">
        ...
        >
          <h2 className="mb-6 text-sm font-semibold text-gray-700">创建管理员账号</h2>
